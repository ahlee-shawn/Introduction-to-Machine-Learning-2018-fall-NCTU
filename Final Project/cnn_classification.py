...
flags.DEFINE_string('labeldir', 'dataset/label_classification.txt', 'set the label root directory')
flags.DEFINE_string('logdir', 'log_cnn_classification/', 'set the log directory')
...
if keep == True:
	...
	if mode == 'train':
		...
		loaded_model.fit(dataset, label, epochs = num_epochs, batch_size = batch_size, callbacks=[TensorBoard(log_dir='tensorboard_classification/')])
...
if keep == False:
	...
	model.fit(dataset, label, epochs = num_epochs, batch_size = batch_size, callbacks=[TensorBoard(log_dir='tensorboard_classification/')])
