...
from utils import load_batched_data, describe, describe, getAttrs, output_to_sequence, list_dirs, logging, count_params, target2phoneme, get_edit_distance
from functionDictUtils import activation_functions_dict, optimizer_functions_dict
from taskUtils import check_path_exists, get_num_classes, dotdict 
...
flags.DEFINE_string('datadir', 'processed/', 'set the data root directory')
            ...
            with tf.Session(graph=model.graph) as sess:
                ...
                for epoch in range(num_epochs):
                    ...
                    for batch, batchOrigI in enumerate(batchRandIxs):
                        ...
                        print(type(batchSeqLengths))
                        batchSeqLengths_cnn = np.divide(batchSeqLengths,2)
                        ...
                        feedDict = {model.inputX: batchInputs, model.targetIxs: batchTargetIxs,
                                    ...
                                    model.seqLengths: batchSeqLengths, model.seqLengths_after_cnn: batchSeqLengths_cnn}
